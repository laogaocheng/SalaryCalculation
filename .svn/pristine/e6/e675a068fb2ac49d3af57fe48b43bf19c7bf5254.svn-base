...
{
    public partial class PrivateSalaryCaluDeptReportForm : XtraForm
    {
        PrivateSalaryCalculateDeptReport report = new PrivateSalaryCalculateDeptReport();
        ...
        public PrivateSalaryCaluDeptReportForm()
        {
        ...
        #region PrivateSalaryCaluDeptReportForm_Load

        private void PrivateSalaryCaluDeptReportForm_Load(object sender, EventArgs e)
        {
            Init();
