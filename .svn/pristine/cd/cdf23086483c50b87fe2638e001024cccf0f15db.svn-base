...
{
    partial class CompanySalaryCountForm
    {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            this.col发放单位 = new DevExpress.XtraPivotGrid.PivotGridField();
            ...
            // col公司
            // 
            this.col公司.Area = DevExpress.XtraPivotGrid.PivotArea.RowArea;
            ...
            // col发放单位
            // 
            this.col发放单位.AreaIndex = 0;
            this.col发放单位.Caption = "发放单位";
            this.col发放单位.FieldName = "发放单位";
            this.col发放单位.Name = "col发放单位";
            // 
            // col省办
            // 
        ...
        private DevExpress.XtraPivotGrid.PivotGridField col发放单位;
