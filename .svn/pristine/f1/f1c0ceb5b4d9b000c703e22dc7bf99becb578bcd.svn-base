...
{
    //半年度职级
    public partial class AdjustJobRank
    {
        static readonly ILog log = LogManager.GetLogger(typeof(AdjustJobRank));
        ...
        public AdjustJobRank(JobRank rank, int year, SemiannualType semiannual, int monthly_salary)
        {
            this.jobRank = rank;
            this.year = year;
