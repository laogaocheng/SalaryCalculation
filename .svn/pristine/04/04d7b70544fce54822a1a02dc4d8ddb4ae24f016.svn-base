...
{
    public class PersonPayRateInputGroup
    {
        public PersonPayRateInput A { get; set; }
        public PersonPayRateInput B { get; set; }

        public PersonPayRateInput GetPersonPayRateInputByEditor(string editor)
        {
