...
{
    public partial class RiseRate72InputForm : XtraForm
    {        
        ...
        public RiseRate72InputForm(string division, string grade, string type, bool isCheck)
            : this()
        {
