...
{
    public partial class TraineeMonthlySalaryItemsForm : XtraForm
    {        
        ...
        public TraineeMonthlySalaryItemsForm(string division, string grade, int year)
            : this()
        {
        ...
        public TraineeMonthlySalaryItemsForm()
        {
        ...
        {
            lbl标题.Text = division + " 届定职人员（" + grade + "）" + year + "年度月薪明细表";

            //控制第一年样式
            bool isFirstYear = division == year.ToString();
            gridBand一季度.Visible = !isFirstYear;
            gridBand二季度.Visible = !isFirstYear;
