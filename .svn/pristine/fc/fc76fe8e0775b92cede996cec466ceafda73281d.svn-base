...
{
    public partial class TraineeYearlySalaryCalculatorForm : XtraForm
    {        
        ...
        public TraineeYearlySalaryCalculatorForm(string division, string grade, int year)
            : this()
        {
        ...
        public TraineeYearlySalaryCalculatorForm()
        {
