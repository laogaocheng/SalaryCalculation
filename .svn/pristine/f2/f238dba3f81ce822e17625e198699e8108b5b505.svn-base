...
{
    public partial class CompanySalaryCountForm : XtraForm
    {

        public CompanySalaryCountForm()
        {
        ...
        protected void LoadData()
        {
            ...
            List<EmployeeSalary> rows = EmployeeSalary.GetEmployeeSalarys(start, end, null);
