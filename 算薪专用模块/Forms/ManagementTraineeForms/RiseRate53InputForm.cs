...
{
    public partial class RiseRate53InputForm : XtraForm
    {        
        ...
        public RiseRate53InputForm(string division, string grade, string type, bool isCheck)
            : this()
        {
