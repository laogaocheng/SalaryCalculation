...
{
    public partial class RiseRate51InputForm : XtraForm
    {        
        ...
        public RiseRate51InputForm(string division, string grade, string type, bool isCheck)
            : this()
        {
