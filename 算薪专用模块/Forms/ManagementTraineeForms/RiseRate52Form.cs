...
{
    public partial class RiseRate52Form : XtraForm
    {        
        string division = null;
        string grade = null;
        string type = null;

        RiseType rise_type_final = RiseType.百分比; //满阶提资类型 

        public RiseRate52Form(string division, string grade, string type)
            : this()
        {
        ...
        {
            lbl标题.Text = division + " 届（" + grade + "）定职人员年薪提资周期及各次提幅标准表";
            LoadData();
        }
        ...
        private void gridView1_CustomColumnDisplayText(object sender, CustomColumnDisplayTextEventArgs e)
        {
            ...
            if (e.Column.FieldName.IndexOf("满阶") != -1) flag = true;
