...
{
    public partial class RiseRate52InputForm : XtraForm
    {        
        ...
        public RiseRate52InputForm(string division, string grade, string type, bool isCheck)
            : this()
        {
