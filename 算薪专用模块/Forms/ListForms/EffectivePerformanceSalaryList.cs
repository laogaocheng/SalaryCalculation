...
{
    public partial class EffectivePerformanceSalaryList : XtraForm
    {
        public EffectivePerformanceSalaryList()
        {
        ...
        private void EffectivePerformanceSalaryList_Load(object sender, EventArgs e)
        {
        ...
        {
            List<EffectivePerformanceSalary> list = EffectivePerformanceSalary.GetAll(Convert.ToInt32(year.EditValue), Convert.ToInt32(month.EditValue));
            //根据权限过滤
