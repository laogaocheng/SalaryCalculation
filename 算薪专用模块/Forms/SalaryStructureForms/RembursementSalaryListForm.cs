...
{
    public partial class RembursementSalaryListForm : XtraForm
    {
        ...
        public RembursementSalaryListForm()
        {
        ...
        {
            all_rows = checkEdit包括已失效的.Checked ? RembursementSalary.GetRembursementSalarys(null, true) : RembursementSalary.GetEffectiveRembursementSalarys();
            LoadData(textEdit关键字.Text.Trim());
        }
