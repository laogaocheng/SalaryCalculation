...
{
    public partial class PrivateSalaryPayBankDetailReportForm : XtraForm
    {
        PrivateSalaryCalculateReport report = new PrivateSalaryCalculateReport();
        
        string 当前期间 = "";
        string 当前账号 = "";
        public PrivateSalaryPayBankDetailReportForm()
        {
        ...
        #region PrivateSalaryPayBankDetailReportForm_Load

        private void PrivateSalaryPayBankDetailReportForm_Load(object sender, EventArgs e)
        {
            Init();
        ...
        #region btn按部门汇总_Click

        private void btn按部门汇总_Click(object sender, EventArgs e)
        {
            PrivateSalaryCaluDeptReportForm form = new PrivateSalaryCaluDeptReportForm();
