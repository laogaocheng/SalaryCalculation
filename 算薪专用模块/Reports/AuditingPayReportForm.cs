...
{
    public partial class AuditingPayReportForm : XtraForm
    {
        AuditingPayReport report = new AuditingPayReport();
        
        string 当前期间 = "";
        string 当前账号 = "";
        public AuditingPayReportForm()
        {
        ...
        #region AuditingPayReportForm_Load

        private void AuditingPayReportForm_Load(object sender, EventArgs e)
        {
            Init();
