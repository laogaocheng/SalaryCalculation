...
{
    public class QueryLevelInputGroup
    {
        public QueryLevelInput A { get; set; }
        public QueryLevelInput B { get; set; }

        public QueryLevelInput GetQueryLevelInputByEditor(string editor)
        {
