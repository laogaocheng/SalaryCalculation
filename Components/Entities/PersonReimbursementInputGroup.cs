...
{
    public class PersonReimbursementInputGroup
    {
        public PersonReimbursementInput A { get; set; }
        public PersonReimbursementInput B { get; set; }

        public PersonReimbursementInput GetPersonReimbursementInputByEditor(string editor)
        {
