...
{
    public class PersonBorrowInputGroup
    {
        public PersonBorrowInput A { get; set; }
        public PersonBorrowInput B { get; set; }

        public PersonBorrowInput GetPersonBorrowInputByEditor(string editor)
        {
