...
{
    public class EmpSalaryStepInputGroup
    {
        public EmpSalaryStepInput A { get; set; }
        public EmpSalaryStepInput B { get; set; }

        public EmpSalaryStepInput GetEmpSalaryStepInputByEditor(string editor)
        {
